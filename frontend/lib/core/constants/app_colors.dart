...
class AppColors {
  ...
  // Order Status Colors
  static const Color statusDraft = Color(0xFF9CA3AF); // Gray
  ...
  static const Color statusShipped = Color(0xFF06B6D4); // Cyan
  static const Color statusDelivered = Color(0xFF10B981); // Green
  static const Color statusCancelled = Color(0xFFEF4444); // Red

  // Payment Status Colors
  static const Color paymentUnpaid = Color(0xFFEF4444); // Red
  static const Color paymentPartial = Color(0xFFF59E0B); // Amber
  static const Color paymentPaid = Color(0xFF10B981); // Green
  static const Color paymentRefunded = Color(0xFF6B7280); // Gray
